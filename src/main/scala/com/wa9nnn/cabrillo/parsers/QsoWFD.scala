...
import com.wa9nnn.cabrillo.model.{CabrilloData, Exchange, Qso, TagValue}
import com.wa9nnn.cabrillo.requirements
import com.wa9nnn.cabrillo.requirements.{AnyNumber, CabrilloError, ContestInfo, TagHandler}
...
case class QSO_NoParse(tag: String, lineNumber: Int, body: String, stamp: Instant = Instant.EPOCH) extends Qso {
  def check()(implicit contestInfo: ContestInfo): Seq[CabrilloError] = {
    Seq(requirements.CabrilloError(lineNumber, body, tag, "Unparsable QSO"))
  }
