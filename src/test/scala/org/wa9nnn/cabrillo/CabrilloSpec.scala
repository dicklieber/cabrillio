...
import org.wa9nnn.cabrillo.requirements.{CabrilloError, MissingTag, ValueError}
...
class CabrilloSpec extends Specification {
  ...
  "CabrilloSpec" should {
    ...
    "nostart" in {
      val expectedError: CabrilloError = MissingTag("START-OF-LOG", "No START-OF-LOG in file!")
    ...
    "bad start version" in {
      val expectedError: CabrilloError = ValueError(0,"2.0","START-OF-LOG","""START-OF-LOG is not "V3.0"""")
